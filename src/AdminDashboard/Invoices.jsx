...
function Invoices() {
    ...
    const fetchURL =
        "https://4e9eq7iw62.execute-api.ap-southeast-1.amazonaws.com/v1/";
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            if (createdInvoice && createdInvoice._id) {
                ...
                console.error(
                    "Invalid response format after creating invoice."
                );
            }
        } catch (error) {
        ...
        try {
            ...
            setInvoices(
                invoices.map((invoiceItem) =>
                    invoiceItem._id === id ? { ...updatedInvoice } : invoiceItem
                )
            );
