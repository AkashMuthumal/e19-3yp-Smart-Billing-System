        ...
        >
            ...
            <div className="header-bar">
                <h2 style={{ color: "white", textAlign: "left" }}>
                    <b>SMART</b>{" "}
                    <span className="thin-text">BILLING SYSTEM</span>
                </h2>
            </div>
                ...
                <div className="row bg-light">
                            ...
                            <div className="d-flex flex-column align-items-start px-3 pt-2 min-vh-100 max-width-5000px">
                                ...
                                >
                                    ...
                                    <li>
                                        ...
                                        >
                                            <i className="fs-4 bi-house-door icon-color"></i>{" "}
                                            <span className="ms-1 d-none d-sm-inline text-dark thin-text">
                                                <b>Dashboard</b>
                                            </span>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link
                                            ...
                                            className="nav-link px-0 align-middle"
                                        >
                                            <i className="fs-4 bi-file-text icon-color"></i>{" "}
                                            <span className="ms-1 d-none d-sm-inline text-dark thin-text">
                                                <b>Invoices</b>
                                            </span>
                                        </Link>
                                    ...
                                    <li>
                                        <Link
                                            ...
                                            className="nav-link px-0 align-middle"
                                        >
                                            <i className="fs-4 bi-cash-coin icon-color"></i>{" "}
                                            <span className="ms-1 d-none d-sm-inline text-dark thin-text">
                                                <b>Sales</b>
                                            </span>
                                        </Link>
                    ...
                    <Link to="/AdminDashboard/Security_Footage" className="nav-link px-0 align-middle">
                      <i className="fs-4 bi-lock icon-color"></i> <span className="ms-1 d-none d-sm-inline text-dark thin-text"><b>Security Footage</b></span>
                                    ...
                                    <li>
                                        <Link
                                            to="/AdminDashboard/Device_Status"
                                            className="nav-link px-0 align-middle"
                                        >
                                            <i className="fs-4 bi-gear icon-color"></i>{" "}
                                            <span className="ms-1 d-none d-sm-inline text-dark thin-text">
                                                <b>Device Status</b>
                                            </span>
                                        </Link>
                                    ...
                                    <li>
                                        <Link
                                            ...
                                            className="nav-link px-0 align-middle"
                                        >
                                            <i className="fs-4 bi-power icon-color"></i>{" "}
                                            <span className="ms-1 d-none d-sm-inline text-dark thin-text">
                                                <b>Logout</b>
                                            </span>
                                        </Link>
